...
root=Tk()
root.geometry("990x650+0+0")
root.title("GHIMIRE'S RESTUARANT AND BAR")
...
#---------------INFO TOP------------
lblinfo = Label(tops,font=('arial',30,'bold'),text="GHIMIRE'S RESTURANT AND BAR",fg="Black",bd=10,anchor='w')
lblinfo.grid(row=0,column=0)
lblinfo = Label(tops,font=('arial',25,),text="Itahari,Sunsari",fg="Black",bd=10,anchor='w')
lblinfo.grid(row=1,column=0)

lblinfo = Label(tops,font=('arial',10,),text=localtime,fg="steel blue",bd=10,anchor='w')
lblinfo.grid(row=2,column=1)

lblinfo = Label(tops,font=('arial',25,'bold'),text="BILL'S RECEIPT",fg="Black",anchor='w')
...
txtreference = Entry(f1, font = ('arial',16,'bold'),textvariable=rand,bd=6,insertwidth=6,bg="white" ,justify='right')
txtreference.grid(row = 0, column =1)


lblfries = Label(f1, font = ('aria',16,'bold'),text = "French fries", fg = "blue", bd=10, anchor='w')
lblfries.grid(row=2,column=0)
txtfries=Entry(f1,font = ('aria',16,'bold'), textvariable=Fries, bd = 6, insertwidth = 4, bg = "green", justify = 'right')
txtfries.grid(row=2,column=1)

lblLargefries = Label(f1,font=('aria',16,'bold'),text = "Large Fries", fg = "blue", bd=10, anchor='w')
lblLargefries.grid(row=3,column=0)
txtLargefries=Entry(f1,font=('aria',16,'bold'),textvariable=Largefries,bd=6,insertwidth=4,bg="green",justify='right')
...
txtburger=Entry(f1,font=('aria',16,'bold'),textvariable=Burger,bd=6,insertwidth=4,bg="green",justify='right')
txtburger.grid(row=4,column=1)

lblFilet=Label(f1,font=('aria',16,'bold'),text="Filet",fg="blue",bd=10,anchor='w')
lblFilet.grid(row=5,column=0)
txtFilet=Entry(f1,font=('aria',16,'bold'),textvariable=Filet,bd=6,insertwidth=4,bg="green",justify='right')
